...
public class Testextentreport 
{
	...
	{    
	    ...
	    ExtentHtmlReporter reporter=new ExtentHtmlReporter("./Report/learn_Extent1.html");
	    ...
	    logger2.fail("Failed because of some issues", MediaEntityBuilder.createScreenCaptureFromPath("C://Users/rahul/Desktop/PAPA.jpg").build());
        
	    logger2.pass("Failed because of some issues", MediaEntityBuilder.createScreenCaptureFromPath("C://Users/rahul/Desktop/PAPA.jpg").build());
